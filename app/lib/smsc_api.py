...
SMSC_LOGIN = "Igul"					# логин клиента
SMSC_PASSWORD = "HgyHFcvF9"				# пароль клиента. Если передан пустой логин, то SMSC_PASSWORD используется, как API ключ, вместо логина и пароля
